...
def process_simulation(xml_file_path, env_folder, task_folder, seed_number, bin_number, crash_counter):
    ...
    if is_terminate:
        print('terminated with seed: ', seed_number)
...
SETTING = None
N_BINS = 100
# possible inaccuracies: 'inaccurate_reward', 'incomplete_state_rep', 'incomplete_state_and_reward'
...
if __name__ == "__main__":
    ...
    for setting in settings:
        SETTING = setting
        parent_directory = f"/scratch/projects/AIProbe-Main/Result/ACAS_XU_Domain/Result/{N_BINS}_bin"
        num_workers =  1
        log_file = f"/scratch/projects/AIProbe-Main/Result/ACAS_XU_Domain/Result/{N_BINS}_bin/{SETTING}_simulation_log.txt"
