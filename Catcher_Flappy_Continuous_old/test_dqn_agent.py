...
if __name__ == "__main__":
    ...
    if env_id=='FlappyBird':
        ...
        checkpoint_path = "Catcher_Flappy_Continuous/wandb/run-20241023_104512-5k3x5x8t/files/flappy_agent_inacc_state_acc_r.pt"  # Path to the saved model checkpoint
