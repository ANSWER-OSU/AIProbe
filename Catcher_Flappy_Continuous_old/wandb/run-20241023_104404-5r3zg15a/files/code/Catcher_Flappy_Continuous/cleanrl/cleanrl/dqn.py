    ...
    for global_step in range(args.total_timesteps):
        if args.save_model:
            ...
            if global_step % CHECKPOINT_FREQUENCY == 0:
                torch.save(q_network.state_dict(), f"{wandb.run.dir}/flappy_agent_inacc_state_inacc_r.pt")
                wandb.save(f"{wandb.run.dir}/flappy_agent_inacc_state_inacc_r.pt", base_path=wandb.run.dir, policy="now")
