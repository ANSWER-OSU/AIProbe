...
class BirdPlayer(pygame.sprite.Sprite):
    ...
    def __init__(self, SCREEN_WIDTH, SCREEN_HEIGHT, init_pos, image_assets, rng,
                 color="red", scale=1.0):
...
class FlappyBird(base.PyGameWrapper):
    ...
    def __init__(self, width=288, height=512, pipe_gap=100, agent_params=None, obj_params=None, env_params=None, inaccuracy_type='accurate', **kwargs):

        self.inaccuracy_type = 'accurate'
        actions = {
            "up": K_w
        }
        ...
        if obj_params==None:
            ...
            self.pipe_gap = obj_params['pipe_gap']
        self.pipe_color = "red"
        self.images = {}
        ...
        if agent_params==None:
            ...
            self.init_pos = agent_params['init_pos']
    ...
    def _load_images(self):
        ...
        for c in ["red", "blue", "yellow"]:
            ...
            try:
                ...
                print(f"Error loading bird images for color {c}: {e}")
                raise
        ...
        for b in ["day", "night"]:
            ...
            try:
                ...
                print(f"Error loading background {b}: {e}")
                raise
        ...
        for c in ["red", "green"]:
            ...
            try:
                ...
                print(f"Error loading pipe images for color {c}: {e}")
                raise
    ...
    def getGameState(self):
        ...
        if self.inaccuracy_type == 'inaccurate_state' or self.inaccuracy_type == 'inaccurate_state_and_reward':
            state = {
            "player_y": self.player.pos_y,
            "player_vel": self.player.vel,
    ...
    def step(self, dt):
        ...
        if self.inaccuracy_type == 'inaccurate_state_and_reward' or self.inaccuracy_type == 'inaccurate_reward':
            self.rewards['positive'] = 0.0
        else:
            self.rewards['positive'] = 1.0
        self.game_tick += 1
        dt = dt / 1000.0
        ...
        self.game_stats['pipe_passed'] = None
        self.game_stats['crashed'] = None
