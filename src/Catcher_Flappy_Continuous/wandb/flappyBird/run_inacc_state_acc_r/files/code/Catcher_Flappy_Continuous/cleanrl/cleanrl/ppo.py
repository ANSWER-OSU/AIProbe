    ...
    for iteration in range(1, args.num_iterations + 1):
        if args.track:
            ...
            if iteration % CHECKPOINT_FREQUENCY == 0:
                torch.save(agent.state_dict(), f"{wandb.run.dir}/flappy_agent_inacc_state_acc_r_2.pt")
                wandb.save(f"{wandb.run.dir}/flappy_agent_inacc_state_acc_r_2.pt", policy="now")
