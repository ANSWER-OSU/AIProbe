...
class Args:
    ...
    wandb_project_name: str = "AIProbe-Catcher"
    ...
    def thunk():
        if capture_video and idx == 0:
            ...
            env = gym.make('Catcher',
                   ...
                   good_fruit_range=(0, 64),
                   bad_fruit_range=(0, 64),
    ...
    for iteration in range(1, args.num_iterations + 1):
        if args.track:
            ...
            if iteration % CHECKPOINT_FREQUENCY == 0:
                torch.save(agent.state_dict(), f"{wandb.run.dir}/flappy_agent_inacc_state_inacc_r_2.pt")
                wandb.save(f"{wandb.run.dir}/flappy_agent_inacc_state_inacc_r_2.pt", policy="now")
