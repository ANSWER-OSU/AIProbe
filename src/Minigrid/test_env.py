...
def evaluate_single_model(xml_file, goal_xml_file, env_number, seed, task_id, num_sim_trials, inaccuracy_type, model_name):
    try:
        ...
        output_csv = f'lava_results_custom_fixed/{model_name}_results_1.csv'
...
def run_evaluation(base_dir):
    ...
    seed_dirs = [
        ...
        if os.path.isdir(os.path.join(base_dir, seed)) #and seed in selected_seeds
    ]
...
if __name__ == "__main__":
    # selected_seeds = ["534", "789", "3768", "4532", "5698", "8967", "11223"]
    #["534", "789", "3768", "4532", "5698", "8967", "11223"]
    # ['12876', '15098', '21456', '22589', '32456', '37012', '54321']
    run_evaluation("/scratch/projects/AIProbe-Main/Result/LavaRoom/Approch_1_Grid_50_Fixed/100_Bin")
