...
def main():
    ...
    xml_file = "/scratch/projects/AIProbe-Main/test_lava/00000/Env_00/Task_000/initialState.xml"  # Update with your XML file path
    #xml_file = ""  # Update with your zXML file path
    ...
    # Save a screenshot
    pygame.image.save(pygame.display.get_surface(), "initial.png")
    ...
    print("saving the environment")
    # Save a screenshot
    pygame.image.save(pygame.display.get_surface(), "final.png")
    print("Saved the environment")
